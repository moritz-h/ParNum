...
for s in sizes:
    ...
    times_csr.append(time("multiply(CSR, CSR)", number = 1))
    times_csc.append(time("multiply(CSC, CSC)", number = 1))
    times_coo.append(time("multiply(COO, COO)", number = 1))
    times_dia.append(time("multiply(DIA, DIA)", number = 1))
